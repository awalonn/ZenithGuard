...
- ZenithGuard is now versioned as `3.3.1` in `package.json`, `package-lock.json`, `manifest.json`, the Gemini client header, and the What&apos;s New fallback/release copy.
- `npm run test:smoke` passes.
- `npm run build` passes.
