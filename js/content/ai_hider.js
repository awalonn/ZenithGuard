// ai_hider.js
// This content script provides the UI and logic for the AI-powered element hider.
...
window.ZenithGuardAIHider = (() => {
    ...
    function createUI() {
        ...
        uiElements = {
            overlay, container,
            title: document.getElementById('zenithguard-ai-hider-title'),
            inputView: document.getElementById('zenithguard-ai-hider-input-view'),
            previewView: document.getElementById('zenithguard-ai-hider-preview-view'),
            errorView: document.getElementById('zenithguard-ai-hider-error-view'),
            errorMessage: document.getElementById('zenithguard-ai-hider-error-message'),
            tryAgainBtn: document.getElementById('zenithguard-ai-hider-try-again'),
            textarea: document.getElementById('zenithguard-ai-hider-textarea'),
            submitBtn: document.getElementById('zenithguard-ai-hider-submit'),
            cancelBtn: document.getElementById('zenithguard-ai-hider-cancel'),
            selectorDisplay: document.getElementById('zenithguard-ai-hider-selector-display'),
            previewActions: document.getElementById('zenithguard-ai-hider-preview-actions'),
            discardBtn: document.getElementById('zenithguard-ai-hider-discard'),
            previewBtn: document.getElementById('zenithguard-ai-hider-preview-btn'),
            applyBtn: document.getElementById('zenithguard-ai-hider-apply-btn'),
        };
    ...
    function showPreviewState(selector) {
        ...
        uiElements.previewActions.querySelector('div').style.display = 'flex';
        uiElements.previewActions.querySelector('div').style.gap = '10px';
    }
    ...
    function start(callback, context = null) {
        if (uiElements) return;

        activeCallback = callback;
        createUI();
        
        // NEW: Pre-populate textarea with context from the clicked element
        ...
        uiElements.overlay.addEventListener('click', (e) => {
             if (e.target === uiElements.overlay) destroyUI();
        });
