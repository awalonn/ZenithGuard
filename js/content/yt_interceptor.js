// ZenithGuard - yt_interceptor.js
// This script is injected into the main page's context to proactively block YouTube ads.

(() => {
    // Check for a marker to ensure this script only runs once.
    if (window.zenithGuardInterceptor) {
        return;
    }
    window.zenithGuardInterceptor = true;
